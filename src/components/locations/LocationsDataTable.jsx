...
function LocationsDataTable({ data, page, onPageChange, pageSize, totalRecords }) {
  return (
    <div>
                  ...
                  {data &&
                    data.map((dt, i) => (
                      <tr className="border-b  hover:bg-gray-100" key={i}>
                        ...
                        <td className="px-4 py-2 font-medium text-blue-700 whitespace-nowrap cursor-pointer">Edit</td>
